...
- [ ] 23-03-PLAN.md — Handler: axum_extra::Query swap + DashboardParams.tags + fleet-tag fold + active-set sort/dedup/intersect + view-models gain fleet_tags/active_tags (TAG-06; V-05, V-07)

**Wave 3** *(blocked on Wave 2 completion)*
- [ ] 23-04-PLAN.md — CSS: cd-tag-chip-* family in @layer components + reduced-motion + print extensions; zero new tokens (TAG-06, TAG-08)
- [ ] 23-05-PLAN.md — Template: ChipView precompute + chip strip insert above filter row + sort-header href widening + poll hx-include widening + OOB swap composition (TAG-06, TAG-08; V-06, V-08..V-14)

**Wave 4** *(blocked on Wave 3 completion)*
- [ ] 23-06-PLAN.md — UAT: 3 just uat-chips-* recipes + README Tag Filter Chips subsection (TAG-06, TAG-07; V-15, V-16)
...
| 23. Job Tagging Dashboard Filter Chips — rc.3 | 2/8 | In Progress|  |
