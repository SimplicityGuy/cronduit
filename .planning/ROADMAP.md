...
- [ ] 19-05-PLAN.md — Wave 3: docs/WEBHOOKS.md operator hub + CONFIG.md back-link + README pointer + 3 wh-example-receiver-* jobs
...
| 19. Webhook HMAC Signing + Receiver Examples | 4/6 | In Progress|  |
