...
3. **Link-free sanity:** no broken internal anchor links; the new section does NOT need to link to Architecture or Quickstart (it's reference material, not a walkthrough).
