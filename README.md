...
| `:latest` | The most recent stable (non-rc) release -- currently `:1.2.1` | Only on stable release tags (`vX.Y.Z` with no `-rc.N` suffix) | Operators who always want the newest stable. Never bleeds rc or main-branch builds in |
